...
const HmhPage = () => (
  <DefaultLayout>
    <CaseStudyHeader
      ...
      welcomeText={" PDS to build an online destination that offers teachers & content creators the opportunity to share digital resources for the classroom."}
    >
      <Label
    ...
    <CaseStudyImage
      imageSrc={Images.HmhMap}
      imageAlt={"HMH Journey Map"}
    />
    <p>
    ...
    <CaseStudyIntro
      heading={"Sketch"}
      description={"Tuesday was all about rapid ideation and collaboration. Afte conducting some industry research as a group, we created a divers set of solutions through short sketching exercises. This was a refreshing experience, as many members of the sprint team were not experienced product designers, and enjoyed the unique opportunity to grab a pen and participate in the process."}
    />
    <CaseStudyImage
