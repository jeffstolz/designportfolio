...
const MobileHeartbeatPage = () => (
  <DefaultLayout>
    <CaseStudyHeader
      title={"The Skills"}
      welcomeText={"Six weeks to build an online education platform to share how world-class athletes train and compete."}
    >
      <Label
    ...
    <CaseStudyIntro
      ...
      description={"With our short runway, there was little time to run extensive preliminary research and design exercises. We relied on the interviews and persona research the client collected in the past and looked to competitors for inspiration and lessons. I created a rough workflow diagram and wireframes to ensure we were aligned with the client on the general user journey and layouts."}
    />
    <CaseStudyImage
    ...
    <CaseStudyIntro
      heading={"Solutions"}
      description={"We iterated rapidly on the design work, establishing a clear visual direction within the first week of the engagement. This allowed us to focus the rest of our efforts on implementation, which was done in Ruby on Rails. The following images are the core screens to the final MVP designs, with placeholder copy and images, which are yet to be determined."}
    />
    <CaseStudyImage
      imageSrc={Images.SkillsHome}
