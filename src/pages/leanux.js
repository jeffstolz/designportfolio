...
const LeanUX = () => (
  <Layout>
    <Seo title="Building a Lean UX Culture" />
    <Container>
      <Menutest3 />
      <Main id="top">
        <Header>
          <HeaderTitle>Building a Lean UX Culture</HeaderTitle>
          <HeaderDescription>
            When I became principal designer of the HPE Experience Studio in
            2024
          </HeaderDescription>
        </Header>
        <IntroImage
